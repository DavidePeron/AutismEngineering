...
To improve the performances of the sessions, the use of \gls{va} has been introducted.
\gls{va} consist of an Avatar, that can be a robot or a virtual character, a learning software that receive information from the Avatar, elaborate them and adjust the response of the Avatar, and an interface for the therapist to interpretate the results.
...
The idea of an Avatar-based therapy session is proposed firstly in \cite{Guerrero-vasquez}. They propose a
