...
During the second task there is a significant difference between \gls{td} children and children with ASD and between the first and the second attempt\DP{Il second task è strutturato come il primo? Come sono gli attempts? Non lo hai spiegato}:
\begin{itemize}
\item Even though there is not a strong correlation among the children of a same group, it can be noticed that both TD children and \gls{asd} children performed better during the second attempt, when they already knew the path to follow a priori;
